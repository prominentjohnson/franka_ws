...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_hw;-lfranka_control_services;/usr/lib/libfranka.so.0.18.2".split(';') if "-lfranka_hw;-lfranka_control_services;/usr/lib/libfranka.so.0.18.2" != "" else []
